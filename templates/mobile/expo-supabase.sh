...
# --- .env.example ---
write_file ".env.example" 'EXPO_PUBLIC_SUPABASE_URL=https://your-project.supabase.co
EXPO_PUBLIC_SUPABASE_ANON_KEY=your-anon-key-here'

# --- lib/supabase.ts ---
write_file "lib/supabase.ts" 'import "react-native-url-polyfill/auto";
...
# --- app/index.tsx ---
write_file "app/index.tsx" 'import { Text, View, Pressable } from "react-native";
...
export default function HomeScreen() {
  ...
  return (
    <View className="flex-1 items-center justify-center bg-white px-6">
      ...
      <Pressable
        className="mt-8 rounded-xl bg-red-600 px-8 py-4 active:bg-red-700"
